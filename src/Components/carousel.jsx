...
class Slide extends Component {
	...
	next() {
		...
		const nextIndex = this.state.activeIndex === items.length - ONE ? ZERO : this.state.activeIndex + ONE;
		this.setState({ activeIndex: nextIndex });
	}

	previous() {
		if (this.animating) {return;}
		const nextIndex = this.state.activeIndex === ZERO ? items.length - ONE : this.state.activeIndex - ONE;
		this.setState({ activeIndex: nextIndex });
	}
